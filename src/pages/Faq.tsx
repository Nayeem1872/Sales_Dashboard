...
export default function FAQSettingsPage() {
  ...
  const handleAddFAQ = () => {
    ...
    toast.success("The FAQ has been added successfully");
  };
  ...
  const handleEditFAQ = () => {
    ...
    toast.success("The FAQ has been updated successfully");
  };

  const handleDeleteFAQ = (id: string) => {
    setFaqs(faqs.filter((faq) => faq.id !== id));

    toast.success("The FAQ has been deleted successfully");
  };
